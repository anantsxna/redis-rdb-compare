...
import static org.example.SlackUtils.getDiffUtils;
...
public class BotSession {
    ...
    @Builder.Default
    private volatile String diffFileA = "";

    @Builder.Default
    private volatile String diffFileB = "";

    @Builder.Default
    private volatile String diffFileC = "";
    ...
    @Setter
    @Builder.Default
    private QTrie trieD = null;

    @Setter
    @Builder.Default
    private QTrie trieE = null;
    ...
    BotSession setFileNames() {
        ...
        this.diffFileA = "./.sessionFiles/diff-A-" + this.getRequestId() + ".txt";
        this.diffFileB = "./.sessionFiles/diff-B-" + this.getRequestId() + ".txt";
        this.diffFileC = "./.sessionFiles/diff-C-" + this.getRequestId() + ".txt";
        try {
    ...
    public String initiateTrieMaking() throws InterruptedException {
        ...
        this.setTrieE(
                QTrie
                    .builder()
                    .keysFile_diff1(this.getDiffFileA())
                    .keysFile_diff2(this.getDiffFileB())
                    .requestId(requestId)
                    .build()
            );
        ...
        this.getTrieMaker().addToTrieMaker(this.getDiffFileA(), this.getTrieE());
